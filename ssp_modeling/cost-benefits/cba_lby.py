...
SSP_RUN  = os.path.join(SSP_PATH, "ssp_modeling/ssp_run_output/sisepuede_results_sisepuede_run_2026-03-11T22;32;24.975382")
...
CB_OUTPUT = os.path.join(SSP_PATH,"ssp_modeling/cost-benefits/output")
