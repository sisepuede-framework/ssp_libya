...
te_all<-read.csv("ssp_modeling/output_postprocessing/data/emission_targets_libya.csv")
...
#ouputfile
dir.output  <- "ssp_modeling/ssp_run_output/sisepuede_results_run_sisepuede_run_2025-07-19T20;27;40.455864/"
output.file <-"sisepuede_results_sisepuede_run_2025-07-19T20;27;40.455864_WIDE_INPUTS_OUTPUTS.csv"
