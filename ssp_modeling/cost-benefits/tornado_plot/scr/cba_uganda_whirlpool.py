...
SSP_RUN  = os.path.join(SSP_PATH, "ssp_modeling/ssp_run_output/sisepuede_results_sisepuede_run_2026-03-06T15;26;14.694911/whirlpool")
...
# Load data
ssp_data = pd.read_csv(os.path.join(SSP_RUN, "libya.csv"))
